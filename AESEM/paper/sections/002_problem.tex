...
(see \cref{subsec:03:salgo} \info{Add reference to HS Algorithm})
...
However some approaches might even work as is on graphs with only the previous two restrictions (see \cref{subsec:03:salgo}) or they may be adapted to work with such graphs while perhaps losing  (see \info{Add reference to HS chapter}). 
